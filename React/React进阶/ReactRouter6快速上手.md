...
2. 子路由path可以不用带 '/' 或 写完整路径 '/home/news'
...
### 7. useInRouterContext()（了解！）

1. 作用：如果组件在 `<Router>` 的上下文中呈现，则 `useInRouterContext` 钩子返回 true，否则返回false。

### 8. useNavigationType()（了解！）
